...
export const DIAGRAMS_HEADING = 'The system in six diagrams'
...
export const DIAGRAMS_ENTRIES: DiagramEntry[] = [
  ...
  },
  {
    ...
    image: '/diagrams/diagram-2-hook-flow.png',
  ...
  {
    id: 'field-rules',
    title: 'Conductor field rules, the behavioral layer above the hooks',
    image: '/diagrams/diagram-4-field-rules.png',
    alt: 'Diagram grouping conductor field rules by phase: before execution, during execution, on failure, and user overrides.',
  ...
  },
  {
    ...
    image: '/diagrams/diagram-5-claudemd.png',
  ...
  },
  {
    ...
    image: '/diagrams/diagram-6-cost-comparison.png',
    alt: 'Bar chart comparing a $31 runaway session before enforcement against an average $1.46 session after enforcement, roughly a 95 percent reduction.',
